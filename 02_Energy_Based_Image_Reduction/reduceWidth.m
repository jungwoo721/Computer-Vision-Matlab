% modified from the given reduceHeight function 
...
% Identify the seam
vertic_seam = find_optimal_vertical_seam(M);
assert(length(vertic_seam) == num_rows);
...
if display_flag 
    ...
    subplot(1, 3, 3); imshow(im); displaySeam(im, vertic_seam, 'VERTICAL');
